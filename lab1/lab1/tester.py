...
def test_summary(dispindex, ntests):
    return f"Test {dispindex}/{ntests}"
...
def run_test(test, lab):
    ...
    if mytype == 'VALUE':
        ...
        raise Exception(f"Test Error: Unknown TYPE .  Please make sure you have downloaded the latest version of the tester script.  If you continue to see this error, contact a TA.")
...
#              for x in tests_module.__dict__.keys() if x[-8:] == "_getargs" ]
    ...
    if ncorrect == ntests:
        print (f"You're done! Run 'python {sys.argv[0]} submit' to submit your code and have it graded.")  
